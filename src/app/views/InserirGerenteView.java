...
public class InserirGerenteView extends javax.swing.JFrame {
    ...
    public InserirGerenteView(Gerente gerente) {
        ...
        jComboBox1.setSelectedIndex(gerente.getDataNascimento().getMinutes());
        jComboBox2.setSelectedIndex(gerente.getDataNascimento().getSeconds());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            dataNascimento = new SimpleDateFormat("dd/MM/yyyy").parse(jTextField7.getText() + "/"
        ...
        try {
            dataAdmissao = new SimpleDateFormat("dd/MM/yyyy").parse(jTextField14.getText() + "/"
